				...
				<div class="form-block text-white ">
					...
					<form action="<%=ORSView.MY_PROFILE_CTL%>" method="post">
						...
						<div class="form-group first text-white mb-0">
							...
							<input name="login" type="text" class="form-control" readonly="readonly" placeholder="Enter Login Id" id="username" value="<%=DataUtility.getStringData(dto.getLogin())%>" required>
						</div>
						<div>
						...
						<div class="form-group first text-white mb-0">
							...
							<input name="mobile" type="number" class="form-control" placeholder="Enter Mobile Number" id="mobile" value="<%=DataUtility.getStringData(dto.getMobileNo())%>" required>
						</div>
						<div>
							<font style="color: red;"><%=ServletUtility.getMessage("mobile", request)%></font>
						</div>
						...
						<div class="form-group last mb-0">
							...
							<input name="dob" type="text" class="form-control " placeholder="dd/mm/yyyy" id="datepicker11" value="<%=DataUtility.getDateString(dto.getDob())%>" readonly="readonly" required>
						</div>
						<div>
						...
						<div class="d-grid gap-2 col-8 mx-auto mt-3 mb-5 text-nowrap">
							<button type="submit" class="btn btn-outline-primary btn-block  " name="operation" value="<%=MyProfile_Controller.OP_SAVE%>">Update Profile</button>
						</div>
