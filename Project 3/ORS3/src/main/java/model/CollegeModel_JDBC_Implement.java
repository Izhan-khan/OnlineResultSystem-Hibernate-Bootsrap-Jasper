 ...
 * 
 */
public class CollegeModel_JDBC_Implement implements CollegeModel_Interface {

    private static Logger log = Logger.getLogger(CollegeModel_JDBC_Implement.class);
    ...
    public Integer nextPK() throws DatabaseException {
        ...
        try {
            ...
            PreparedStatement pstmt = conn
                    .prepareStatement("SELECT MAX(ID) FROM COLLEGE");
    ...
    public long add(CollegeDTO dto) throws ApplicationException,
        ...
        try {
            ...
            PreparedStatement pstmt = conn
                    .prepareStatement("INSERT INTO COLLEGE VALUES(?,?,?,?,?,?,?,?,?,?)");
            pstmt.setInt(1, pk);
    ...
    public void delete(CollegeDTO dto) throws ApplicationException {
        ...
        try {
            ...
            conn.setAutoCommit(false); // Begin transaction
            PreparedStatement pstmt = conn
                    .prepareStatement("DELETE FROM COLLEGE WHERE ID=?");
    ...
    public void update(CollegeDTO dto) throws ApplicationException,
        ...
        try {
            ...
            conn.setAutoCommit(false); // Begin transaction
            PreparedStatement pstmt = conn
                    .prepareStatement("UPDATE COLLEGE SET NAME=?,ADDRESS=?,STATE=?,CITY=?,PHONE_NO=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
