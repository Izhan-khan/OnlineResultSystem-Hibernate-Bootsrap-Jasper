 ...
 * 
 */
public class MarksheetModel_Hibernate_Implement implements MarksheetModel_Interface {

	private static Logger log = Logger.getLogger(MarksheetModel_Hibernate_Implement.class);
    ...
    public List getMeritList(int pageNo, int pageSize)
            throws ApplicationException {
        log.info("Model getMeritList Started");
        Session session = null;
        List list = null;
        try {
            session = HibernateDataSource.getSession();
        ...
        log.info("Model getMeritList End");
        return list;
    }
