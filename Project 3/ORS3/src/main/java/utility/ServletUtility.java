...
public class ServletUtility {
    ...
    public static void setErrorMessage(String msg, HttpServletRequest request) {
        request.setAttribute(Base_Controller.MSG_ERROR, msg);
    }
    ...
    public static String getErrorMessage(HttpServletRequest request) {
        String val = (String) request.getAttribute(Base_Controller.MSG_ERROR);
        if (val == null) {
            return "";
        } else {
            return val;
    ...
    public static void setSuccessMessage(String msg, HttpServletRequest request) {
        request.setAttribute(Base_Controller.MSG_SUCCESS, msg);
    }
    ...
    public static String getSuccessMessage(HttpServletRequest request) {
        String val = (String) request.getAttribute(Base_Controller.MSG_SUCCESS);
        if (val == null) {
            return "";
        } else {
            return val;
