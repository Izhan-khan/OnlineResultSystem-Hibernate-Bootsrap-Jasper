...
public class DataUtility {
    ...
    public static Timestamp getTimestamp(String val) {
        ...
        try {
            ...
            try {
            	SimpleDateFormat timeFormatter2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                timeStamp = new Timestamp((timeFormatter2.parse(val)).getTime());
			}catch (Exception e1) {
    ...
    public static void main(String[] args) {
        System.out.println(getTimestamp("2021-05-03 20:17:17.9611662"));
    }
